        ...
        <>
            <div className="app__allcourses section__padding">
                <h3 className="app__allcourses-heading p__heading">
                    {
                        type === "MobiusInfo" ? "Courses Offered" : "All Courses"
                    }
                </h3>
                <div className="app__allcourses-coursecontainer">
                    {
                        AllSnaplogicCourses.map( (course, idx) => <MobiusCourseCard title={course.title} illustration={course.illustration} navigatinglink={course.navigatinglink} key={"Course " + course.title + idx} />)
                    }
                </div>
            </div>
        </>
